...
public class CashierSign {
    ...
    public static byte[] sign(String bpId ,String invokeCashierKey,String channel,String payType,String outTradeNo,String body,String attach,String totalFee
    		,String backPkgName,String backClassPath,String notifUrl) throws UnsupportedEncodingException, NoSuchAlgorithmException {
...
//        dataMap.put("notify_url",notifUrl);
    ...
    public static byte[] refundsign(String bpId ,String invokeCashierKey,String cashier_trade_no
