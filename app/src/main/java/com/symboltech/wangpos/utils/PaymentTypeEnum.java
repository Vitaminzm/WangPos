...
public enum PaymentTypeEnum {
	...
	CASH("1"), STORE("2"),SCORE("106"), BANK("3"), WECHAT("5"), ALIPAY("4"), COUPON("8"), YUXF("10"),LING("99999"), HANDRECORDED("101"), ALIPAYRECORDED("102"), WECHATRECORDED("103") ,RECORDED_CAREDUCTION("104"), ALLWANCE_COMPENSATION("105"), ERR("201");
