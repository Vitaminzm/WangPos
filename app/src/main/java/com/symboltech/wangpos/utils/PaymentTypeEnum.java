...
public enum PaymentTypeEnum {
	...
	CASH("0"), STORE("11"),SCORE("3"), BANK("7"), WECHAT("12"), ALIPAY("12"), COUPON("4"), LING("99999"), HANDRECORDED("101"), ALIPAYRECORDED("102"), WECHATRECORDED("103") ,RECORDED_CAREDUCTION("104"), ALLWANCE_COMPENSATION("105"), RECORD("9999"),ERR("201");
