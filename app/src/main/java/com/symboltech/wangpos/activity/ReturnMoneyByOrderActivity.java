        ...
        if (bankFlag < bankStyle.size()) {
            ...
            if("true".equals(entity.getDes())){
                ...
                if(MyApplication.posType.equals(ConstantData.POS_TYPE_W)){
                    ...
                    final String tradeNo = Utils.formatDate(new Date(System.currentTimeMillis()), "yyMMddHHmmss") + Utils.randomString(6);
                        ...
                        new BankreturnDialog(this, getString(R.string.store_return), entity.getCardno(), entity.getAmount(), new DialogFinishCallBack() {
                            ...
                            public void finish(int position) {
                               if(position == 1){
                                   ...
                                   AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.STORE, ConstantData.YHK_TH, json, listener);
                               }else if(position == 2){
                                   try {
                                   ...
                                   AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.STORE, ConstantData.YHK_CX, json, listener);
                               }
                            }
                        }).show();
                        ...
                        new BankreturnDialog(this, getString(R.string.bank_return), entity.getCardno(), entity.getAmount(), new DialogFinishCallBack() {
                            ...
                            public void finish(int position) {
                                if(position == 1){
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.YHK_SK, ConstantData.YHK_TH, json, listener);
                                }else if(position == 2){
                                    try {
                                        json.put("orgTraceNo",entity.getBatchno());
                                        json.put("extOrderNo", tradeNo);
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.YHK_SK, ConstantData.YHK_CX, json, listener);
                                }
                            }
                        }).show();
                        ...
                        new BankreturnDialog(this, getString(R.string.wechat_return), entity.getCardno(), entity.getAmount(), new DialogFinishCallBack() {
                            ...
                            public void finish(int position) {
                                if(position == 1){
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.POS_TONG, ConstantData.YHK_TH, json, listener);
                                }else if(position == 2){
                                    try {
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.POS_TONG, ConstantData.POS_XFCX, json, listener);
                                }
                            }
                        }).show();
                        ...
                        new BankreturnDialog(this, getString(R.string.qmh_return), entity.getCardno(), entity.getAmount(), new DialogFinishCallBack() {
                            ...
                            public void finish(int position) {
                                if(position == 1){
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.QMH, ConstantData.YHK_TH, json, listener);
                                }else if(position == 2){
                                    try {
                                        json.put("orgTraceNo",entity.getBatchno());
                                        json.put("extOrderNo", tradeNo);
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.QMH, ConstantData.YHK_CX, json, listener);
                                }
                            }
                        }).show();
                    }
...
//                }
    ...
    IOnTransEndListener listener = new IOnTransEndListener() {
        ...
        public void onEnd(final String reslutmsg) {
            ...
            ReturnMoneyByOrderActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
