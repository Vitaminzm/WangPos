...
import com.symboltechshop.wangpos.adapter.ReturnReasonAdapter;
import com.symboltechshop.wangpos.adapter.ReturnTableAdapter;
...
import com.symboltechshop.wangpos.dialog.AlipayAndWeixinPayReturnDialog;
import com.symboltechshop.wangpos.dialog.BankreturnDialog;
import com.symboltechshop.wangpos.dialog.ThirdPayReturnDialog;
...
import com.symboltechshop.wangpos.interfaces.OnReturnFinishListener;
import com.symboltechshop.wangpos.log.LogUtil;
import com.symboltechshop.wangpos.msg.entity.BankPayInfo;
...
import com.symboltechshop.wangpos.msg.entity.WposBankRefundInfo;
import com.symboltechshop.wangpos.print.PrepareReceiptInfo;
import com.symboltechshop.wangpos.result.SaveOrderResult;
...
import com.symboltechshop.wangpos.utils.CashierSign;
import com.symboltechshop.wangpos.utils.CurrencyUnit;
...
import com.symboltechshop.wangpos.view.ListViewForScrollView;
    ...
    protected void initData() {
        ...
        if(MyApplication.posType.equals(ConstantData.POS_TYPE_W)){
            ...
            if (printService != null)
                bindService(printService, printerServiceConnection, BIND_AUTO_CREATE);
        }
    }
        ...
        if (bankFlag < bankStyle.size()) {
            ...
            if("true".equals(entity.getDes())){
                ...
                if(MyApplication.posType.equals(ConstantData.POS_TYPE_W)){
                    ...
                    }else if(PaymentTypeEnum.WEIPAY_BANK.getStyletype().equals(type)){
                    ...
                    }else if(PaymentTypeEnum.ALIPAY_BANK.getStyletype().equals(type)){
                    ...
                    }else if(PaymentTypeEnum.YXLM_BANK.getStyletype().equals(type)){
                        new BankreturnDialog(this, getString(R.string.qmh_return), entity.getCardno(), entity.getAmount(), new DialogFinishCallBack() {
                            @Override
                            public void finish(int position) {
                                if(position == 1){
                    ...
                    }else if(PaymentTypeEnum.YIPAY_BANK.getStyletype().equals(type)){
                        new BankreturnDialog(this, getString(R.string.qmh_return), entity.getCardno(), entity.getAmount(), new DialogFinishCallBack() {
                            @Override
                            public void finish(int position) {
                                if(position == 1){
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.QMH, ConstantData.YIPAY_TH, json);
                                }else if(position == 2){
                                    try {
                                        json.put("orgTraceNo",entity.getBatchno());
                                        json.put("extOrderNo", tradeNo);
                                    ...
                                    AppHelper.callTrans(ReturnMoneyByOrderActivity.this, ConstantData.QMH, ConstantData.YIPAY_CX, json);
                                }
                            }
                        }).show();
                    }
                ...
                new AlipayAndWeixinPayReturnDialog(this, thirdPay.getPay_type(), thirdPay.getTrade_no(), AppConfigFile.getBillId(), thirdPay.getPay_total_fee(), new OnReturnFinishListener() {
                    ...
                    public void finish(boolean isSuccess) {
                        ...
                        if (isSuccess) {
                            ...
                            putPayments(getPayTypeId(PaymentTypeEnum.STORERECORDED), idNames.get(getPayTypeId(PaymentTypeEnum.STORERECORDED)), PaymentTypeEnum.STORERECORDED.getStyletype(), "-" + thirdPay.getPay_total_fee());
                        }
                        alipayFlag += 1;
                        if (alipayFlag < thirdAlipays.size()) {
                            returnAlipay();
