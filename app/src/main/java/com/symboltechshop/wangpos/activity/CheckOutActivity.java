...
import com.symboltechshop.wangpos.result.ThirdPayInfoResult;
...
public class CheckOutActivity extends BaseActivity {
    ...
    private void doPay(double money) {
        ...
        switch (PaymentTypeEnum.getpaymentstyle(type.trim())){
            ...
            case BANK_CODE:
            case ALIPAY:
                if(PaymentTypeEnum.WECHAT.getStyletype().equals(type.trim())){
                    paytype = ConstantData.PAYMODE_BY_WEIXIN;
                }else if(PaymentTypeEnum.ALIPAY.getStyletype().equals(type.trim())){
                    paytype = ConstantData.PAYMODE_BY_ALIPAY;
                }else if(PaymentTypeEnum.BANK_CODE.getStyletype().equals(type.trim())){
                    paytype = ConstantData.PAYMODE_BY_BANKCODE;
                }else if(PaymentTypeEnum.YIPAY.getStyletype().equals(type.trim())){
