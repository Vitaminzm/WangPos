...
import com.symboltechshop.wangpos.adapter.AddGoodAdapter;
 ...
 * @version 1.0
 */
public class AddGoodDialog extends BaseDialog implements View.OnClickListener {
	...
	private void setdata() {
		text_title.setText(context.getString(R.string.add_good));
