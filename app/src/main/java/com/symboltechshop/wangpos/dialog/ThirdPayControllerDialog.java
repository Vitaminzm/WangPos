...
import com.symboltechshop.koolcloud.transmodel.AidlPaymentInfo;
...
import com.symboltechshop.wangpos.result.ThirdPayQueryResult;
...
import com.symboltechshop.koolcloud.interfaces.RemoteServiceStateChangeListerner;
...
import com.symboltechshop.wangpos.msg.entity.WposPayInfo;
import com.symboltechshop.wangpos.result.ThirdPayCancelResult;
import com.symboltechshop.wangpos.result.ThirdPayResult;
import com.symboltechshop.wangpos.result.ThirdPaySalesReturnResult;
import com.symboltechshop.wangpos.service.RunTimeService;
import com.symboltechshop.wangpos.utils.ArithDouble;
import com.symboltechshop.wangpos.utils.CodeBitmap;
	...
	public void onClick(View v) {
		...
		switch (id){
			...
			case R.id.text_confirm:
				keyboard.dismiss();
				int type =  Integer.parseInt(type_function);
				switch (type){
					case 1://ConstantData.TRANS_SALE:
						doTrans();
						break;
					case 3://ConstantData.TRANS_RETURN:
						doReturn();
						break;
					case 2://ConstantData.TRANS_REVOKE:
						doRevoke();
						break;
				}
				break;
